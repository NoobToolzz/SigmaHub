...
if game.PlaceId == 15154513235 then
    local Window = Fluent:CreateWindow({
        Title = "Nigga Hub - Kamehameha Simulator",
        SubTitle = "by NiggaMan",
        TabWidth = 160,
    ...
    do
        ...
        Tabs.Home:AddParagraph({
            Title = "Welcome to Nigga Hub!",
            Content = "Enjoy using nigga hub! I don't know what else to say."
        })
        ...
        local quickStatsButton = Tabs.Training:AddButton({
            ...
            Callback = function()
                game:GetService("ReplicatedStorage").Remotes.AddWheelSpinValue:FireServer("Power", 9990000000000000000000000000999)
